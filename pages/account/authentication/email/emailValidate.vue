          ...
          <div class="body">
            ...
            <el-form ref="form" :model="form" label-width="120px" :rules="rules">
              <el-form-item label="邮箱" prop="userId">
                <el-input class="w-270" disabled v-model="form.userId"></el-input>
              </el-form-item>
              <el-form-item label="验证码" prop="email">
                <el-input class="w-270" disabled v-model="form.email"></el-input>
                <!-- <el-button type="button" @click="sendCode">发送验证码</el-button> -->
              </el-form-item>
              <!-- <el-form-item label="验证码" prop="validateCode">
                <el-input style="width:120px" v-model="form.emailCode" placeholder="请输入验证码"></el-input>
              </el-form-item> -->
              <el-form-item>
                <el-button class="red-btn" @click="postCommit">验证</el-button>
              </el-form-item>
              <el-form-item>
...
export default {
  data() {
    ...
    var validateCode = (rule, vaule, callback) =>{
          if(value == ''){
    ...
    return {
      ...
      rules: {
        ...
        // validateCode: [{ require: true, validator: validateCode, trigger: "blur" }]
      }
    };
  },
  components: {
...
.screen-main {
  ...
  .body {
    ...
    .progres span.progres_des > span > i {
      background: url(/img/mbk/ico_main.png) no-repeat 0 -280px;
      width: 24px;
      height: 24px;
      overflow: hidden;
    ...
    .progres span.progres_tip > span.success > i {
      background-position: -50px -330px;
       ...
       .progres span.progres_tip > span.success > font{
      color: #ec2828;
    }
    ...
    .progres span.progres_des > span.select > font,
    .progres span.progres_des > span.successon > font {
      color: #ec2828;
    }
